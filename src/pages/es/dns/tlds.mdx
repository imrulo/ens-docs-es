# Lista de TLD Soportados [Cualquier TLD DNS que soporte DNSSEC puede usarse con ENS]
...
A continuación hay una lista de todas las implementaciones de TLD personalizadas conocidas:
