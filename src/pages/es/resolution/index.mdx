...
El proceso de resolución involucra múltiples partes. Más notablemente el [Registro](/es/registry/ens), múltiples Registradores ([Registrador ETH](/es/registry/eth), [Registrador DNS](/es/registry/dns), [Registrador Inverso](/es/registry/reverse), etc)
...
Para obtener el resolver responsable de un nombre, puedes consultar [El Registro](/es/registry/ens) para el `resolver` de un nombre.
...
Más sobre cargar información de un resolver se puede encontrar [aquí](/es/resolvers/interacting).
...
Ten en cuenta que muchas bibliotecas ya tienen funcionalidad para hacer esto. Puedes leer más sobre esto en la sección [Obtener un Nombre Primario](/es/web/reverse).
