...
description: El Protocolo ENS tiene como objetivo hacer fácil el uso de Ethereum proporcionando una forma simple de usar nombres legibles por humanos en lugar de direcciones largas legibles por máquinas.
---
...
Lo hace proporcionando una forma simple de usar nombres legibles por humanos en lugar de direcciones largas legibles por máquinas.
